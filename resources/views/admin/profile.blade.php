...
@section('content')
    ...
    <section class='flex flex-row justify-between items-start gap-x-6 w-full pt-4'>
        ...
        <div style="box-shadow: 2px 2px 4px 4px rgba(0,0,0,0.1);"
            ...
            <!-- Profile image with edit icon - centered container -->
            <div class="w-full flex justify-center">
                <!-- Relative container for absolute positioning of pen icon -->
                <div class="relative">
                    <!-- Profile image -->
                    <img src="{{ $photo }}" alt="my profile picture"
                        class="rounded-full w-32 h-32 object-cover ring-8 ring-gray-400" />
                    
                    <!-- Edit pen icon - transparent blurred background -->
                    <button onclick="document.getElementById('photoModal').classList.remove('hidden')" class="absolute bottom-2 right-2 backdrop-blur-sm bg-black/60 text-white p-2 rounded-full hover:bg-black/70 transition-colors shadow-md flex items-center justify-center w-8 h-8 hover:cursor-pointer">
