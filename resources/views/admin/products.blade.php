                        ...
                        <div @click.outside="showModal = false" class="bg-white p-6 rounded-lg w-full max-w-md shadow-lg">
                            ...
                            <form action="#" method="POST" class="flex flex-col gap-4">
                                <div>
                                    ...
                                    <input type="text" name="name" class="w-full border-b border-gray-300 focus:outline-none focus:border-black py-1" required>
                                </div>
                                    <div>
                                        <label class="block text-sm font-medium">Category</label>
                                        <select name="category" class="w-full border-b border-gray-300 focus:outline-none focus:border-black py-1" required>
                                            <option value="">Select Category</option>
                                            <option value="vinywaji">Vinywaji</option>
                                            <option value="vitafunwa">Vitafunwa</option>
                                            <option value="usafi">Huduma Binafsi</option>
                                            <option value="vyombo">Vifaa vya Usafi</option>
                                        </select>
                                    </div>
                                <div>
                                    <label class="block text-sm font-medium">Buying Price</label>
                                    <input type="number" name="buying_price" class="w-full border-b border-gray-300 focus:outline-none focus:border-black py-1" required>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium">Selling Price</label>
                                    <input type="number" name="selling_price" class="w-full border-b border-gray-300 focus:outline-none focus:border-black py-1" required>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium">Quantity</label>
                                    <input type="number" name="quantity" class="w-full border-b border-gray-300 focus:outline-none focus:border-black py-1" required>
                                </div>

                                <div class="flex justify-end gap-2 pt-4">
                                    <button type="button" @click="showModal = false" class="px-4 py-2 text-sm bg-gray-200 rounded">Cancel</button>
                                    <button type="submit" class="px-4 py-2 text-sm bg-black text-white rounded">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <table class="min-w-full border text-xs text-left">
                    ...
                    <tbody class="text-gray-800">
                        ...
                        <template x-for="item in products" :key="item.id">
                            <tr>
                                <td class="px-3 py-4 text-center border border-gray-400" x-text="item.id"></td>
