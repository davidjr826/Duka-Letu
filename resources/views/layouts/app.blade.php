...
<div x-data="{ collapsed: false }">
  ...
  <aside 
    ...
    class="fixed top-1.5 bottom-3 left-2 flex flex-col bg-white border-2 border-gray-400 shadow-lg transition-all duration-300 ease-in-out z-40 rounded-2xl overflow-hidden"
  >
          ...
          <div x-data="{ open: false }" class="w-full">
            ...
            <div x-show="open" class="mt-1 space-y-1 w-full">
              <a href="{{ route('student_loan') }}" class="flex items-center px-4 py-2 hover:bg-gray-50 w-full pt-3">
                ...
                <span x-show="!collapsed" class="ml-3 text-sm">Recruit Loan</span>
              </a>
              ...
              <a href="{{ route('changes') }}" class="flex items-center px-4 py-2 hover:bg-gray-50 w-full">
                ...
                <span x-show="!collapsed" class="ml-3 text-sm">Changes</span>
              </a>
            </div>
          </div>
        </nav>
    ...
    >
      ...
      <div class="flex items-center space-x-6">
        ...
        <div class="flex items-center gap-x-5 text-xl">
          ...
          <i class="fa-solid fa-moon text-gray-600 cursor-pointer"></i>
        </div>
      </div>
    </header>
